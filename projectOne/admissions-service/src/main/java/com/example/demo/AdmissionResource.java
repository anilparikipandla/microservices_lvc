...
public class AdmissionResource {
	...
	public BloodTypeList getBloodTypeOrders() {
		BloodTypeList bloodTypeOrders = restTemplate.getForObject("http://bloodstore-service/bloodstore/bloodtypes", BloodTypeList.class);
		return bloodTypeOrders;
	}
